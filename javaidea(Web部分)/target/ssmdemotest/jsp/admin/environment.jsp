...
<title>智慧能源系统环境信息</title>
<link
	href="{pageContext.request.contextPath}../../css/admin/cssMain/bootstrap.css"
	rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet"
	href="{pageContext.request.contextPath}../../css/admin/cssMain/style.css"
	type="text/css" media="all" />
<link rel="stylesheet"
	href="{pageContext.request.contextPath}../../css/admin/cssMain/font-awesome.css"
	type="text/css" media="all" />
<link rel="stylesheet"
	href="{pageContext.request.contextPath}../../css/admin/cssMain/colorbox.css"
	type="text/css" media="all" />
<!-- font -->
...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav link-effect">
						...
						<li class="active"><a href="/SmartEnergy/environment.action">环境信息</a></li>
	...
	<div style="width: 50%; margin-left: 25%; text-align: left">
		...
		<table id="sampleTableA" class="table table-striped sampleTable">
			...
			<tbody>
				<c:forEach items="${envirsList }" var="item">
					<tr>
						...
						<td><button deviceId="${item.device_id}" type="button"
								class="btn btn-primary detEnvirBtn">详情</button></td>
	...
	<!-- 模态框（Modal） -->
	<div class="modal fade" id="detEnvir" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">设备环境详情</h4>
				</div>
				<div class="modal-body" id="hjxq" style="width: 500px; height: 300px;">
				</div>
...
<script type="text/javascript">
	...
	$(function() {
		$(".detEnvirBtn").on("click", function() {
			
			var device_id = $(this).attr("deviceId")
			//alert(device_id)
			$.ajax({
					//访问后台的地址
					url : "/SmartEnergy/detEnvirById.action",
					//携带的数据
					data : {
						id : device_id
					},
					...
					success : function(res) {
						//console.log(res)
						 var myChart = echarts.init(document.getElementById('hjxq'));
					        // 指定图表的配置项和数据
					        var option = {
					        	    title: {
					        	        text: '折线图堆叠'
					        ...
					        $("#myModalLabel").html(device_id+"号设备环境详情")
						$('#detEnvir').modal()
